...
const DashboardSellerPageWrapper = (props: DashboardPageProps) => {
  return (
    <Suspense fallback={<DashboardSellerLoading />}>
      <DashboardPage {...props} />
    </Suspense>
  );
};

export default DashboardSellerPageWrapper;
