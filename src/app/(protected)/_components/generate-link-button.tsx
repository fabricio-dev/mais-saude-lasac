      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            automaticamente associados a você.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          <div>
            <Label htmlFor="link">Seu link personalizado:</Label>
            <div className="flex">
              <Input
                id="link"
                value={personalLink}
          ...
          <div className="rounded-lg bg-emerald-50 p-4">
            ...
            <ul className="mt-2 space-y-1 text-sm text-emerald-700">
              <li>• Clientes acessam seu link personalizado</li>
              <li>• Preenchem o formulário de convênio</li>
              <li>• São automaticamente associados ao vendedor e Unidade</li>
